...
#' tiff, jpeg, and bmp).
#'
#' @param img \code{picture}. A [Picture][grImport2::Picture-class] object. For
#'   PhyloPic silhouettes, this is generated by
#'   \code{\link[rphylopic]{get_phylopic}}.
#' @param path \code{character}. The output file path. The name of the file and
#'   file extension should be included (e.g. "./phylopic.png"). If this argument
#'   is `NULL` (default), the file is automatically saved in the current working
#'   directory as a png file.
#' @param ... Additional arguments available for the called grDevices function.
#'   The called function is determined by the file extension used in `path`
#'   (e.g. \code{\link[grDevices]{png}}).
#'
#' @return An image is saved. Nothing is returned to the R interface.
#'
#' @details This function can be used to save a PhyloPic image obtained via the
#'   \code{\link[rphylopic]{get_phylopic}} or any object of class `Picture` from
#'   the grImport2 package. Any file format available in the grDevices package
